...
class $AssetsAnimGen {
  ...
  /// File path: assets/anim/a.json
  String get a => 'assets/anim/a.json';

  /// List of all assets
  List<String> get values => [a];
}
...
class $AssetsLanguagesGen {
  ...
  /// File path: assets/languages/vn.json
  String get vn => 'assets/languages/vn.json';
...
class $AssetsSvgGen {
  ...
  SvgGenImage get a => const SvgGenImage('assets/svg/a.svg');

  /// List of all assets
  List<SvgGenImage> get values => [a];
}
